...
const Navbar = () => {
  ...
  const theme = "light"; // Replace with actual theme state from context or props
          ...
          <div className="flex items-center space-x-3">
            <div>
              <button
                ...
                className="p-2 rounded-full text-gray-500 hover:text-primary cursor-pointer transition-color focus:outline-none"
              >
                <BsSearch size={18} />
              </button>
              {isSearchOpen && (
            ...
            <Show when="signed-out">
              <SignInButton mode="modal">
                <button className="px-5 py-1.5 border border-gray-300 bg-green-600 text-white rounded-md hover:bg-green-700 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-primary cursor-pointer">
                  Sign In
                </button>
              </SignInButton>
            </Show>
